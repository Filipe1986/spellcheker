...
public class TestSpellChecker {
	...
	/*
	 * @Test public void testLevenshteintTecladoNeutro() { KeyboardLayout layout
	 * = new KeyboardLayoutNeutral(); layout.prepareDistances();
	 * 
	 ...
	 * 
	 * System.out.println(calculator.isKeyboardLayoutNeutral()); check(result1,
	 * 0, "casa", 0.0); check(result1, 1, "asa", 1.0); check(result1, 2, "cas",
	 * 1.0); check(result1, 3, "casar", 1.0); check(result1, 4, "casal", 1.0);
	 * check(result1, 5, "causa", 1.0); check(result1, 6, "casba", 1.0);
	 * check(result1, 7, "casca", 1.0); check(result1, 8, "casta", 1.0);
	 * check(result1, 9, "caca", 1.0);
	 * 
	 * BurkhardKellerTreeSearchResult result2 = tree.search("cervega", 2, 10);
	 * check(result2, 0, "cerveja", 1.0); check(result2, 1, "cereja", 2.0);
	 * check(result2, 2, "corveta", 2.0); check(result2, 3, "corveia", 2.0);
	 * check(result2, 4, "certeza", 2.0);
	 * 
	 * BurkhardKellerTreeSearchResult result3 = tree.search("aviea", 2, 10);
	 * check(result3, 0, "aia", 2.0); check(result3, 1, "ave", 2.0);
	 * check(result3, 2, "via", 2.0); check(result3, 3, "avioes", 2.0);
	 * check(result3, 4, "avisar", 2.0); check(result3, 5, "avivar", 2.0);
	 * check(result3, 6, "avidez", 2.0); check(result3, 7, "alinea", 2.0);
	 * check(result3, 8, "ravina", 2.0); check(result3, 9, "vies", 2.0); }
	 */
	/*
	 * @Test public void testDemerauTecladoNeutro() { KeyboardLayout layout =
	 * new KeyboardLayoutNeutral(); layout.prepareDistances();
	 ...
	 * 
	 * BurkhardKellerTreeSearchResult result1 = tree.search("casa", 1, 10);
	 * check(result1, 0, "casa", 0.0); check(result1, 1, "asa", 1.0);
	 * check(result1, 2, "cas", 1.0); check(result1, 3, "casar", 1.0);
	 * check(result1, 4, "casal", 1.0); check(result1, 5, "causa", 1.0);
	 * check(result1, 6, "casba", 1.0); check(result1, 7, "casca", 1.0);
	 * check(result1, 8, "casta", 1.0); check(result1, 9, "caca", 1.0);
	 * 
	 * BurkhardKellerTreeSearchResult result2 = tree.search("cervega", 2, 10);
	 * check(result2, 0, "cerveja", 1.0); check(result2, 1, "cereja", 2.0);
	 * check(result2, 2, "corveta", 2.0); check(result2, 3, "corveia", 2.0);
	...
	public void testLevenshteinTecladoQwerty() {
		...
		System.out.println(calculator.isKeyboardLayoutNeutral());
